...
const Demo1000 = (props) => {
  ...
  const mintDemo1000 = useCallback(() => { props.MINT_DEMO_1000() }, [])
  ...
  return (
    <AnimatedButton
      ...
      disabled={confirming}
    >
      <div className={cn(css.container, css.green, {
...
export default connect(
  (state, props) => ({
    ...
    minting: !isEmpty(getPendingTransactionsByEntityId(state, hexHash({ MINT_DEMO_1000 }))),
