...
import { getLastClaimablePrediction, getRoundByPredictionId, isLoading } from '@state/getters'
import { getSettlmentById, isEntityPropagating } from '@state/getters'
  ...
  return (
    ...
    >
      <div className={cn(css.container, {
        ...
        [css.disabled]: confirming || propagating,

        propagating: confirming || propagating,
      })}>
        <div className={css.gradient} />
        <div className={css.content} title={htmlCurrencyNamed(prize, round.currency)}>
          <Coin
