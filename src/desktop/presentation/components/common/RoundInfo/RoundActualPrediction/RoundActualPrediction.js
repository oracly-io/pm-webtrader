...
import { getRelationNotifications, getLatestPriceByPricefeed, getSettlmentById } from '@state/getters'
...
const RoundActualPrediction = props => {
  ...
  return (
    <div className={cn(css.container, {
      ...
      {!isEmpty(notifications) && map(notifications, (notification, id) => (
...
export default connect(
  (state, props) => {
    const notifications = getRelationNotifications(state, props.prediction.predictionid)
