    ...
    <div className={cn(css.bettor, className)}>
      ...
      <div className={css.wager}>
        <div className={css.position}
          title={[predictionPositions[prediction.position], htmlCurrencyNamed(prediction.wager, round.currency)].join(' ')}
        >
        ...
        {!round.resolved &&
          ...
          >
            ...
            <LevelCurrency className={css.level} currency={round.currency} type={game.level} />
          </div>
        }
        {round.resolved &&
          <div
