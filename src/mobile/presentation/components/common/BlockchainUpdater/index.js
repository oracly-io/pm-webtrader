...
import { RESOVLE_ADDRESS_TO_NICKNAME, APPLICATION_NETWORK_STATUS } from '@actions'
...
import { getBettingBettorPredictionsSize, getLatestbcBlock, getStakingActualEpochId, isOnline } from '@state/getters'
